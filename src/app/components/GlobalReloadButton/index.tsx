...
import { getPchainOverreview, getTimeFrameXchain, getXchainOverreview } from 'store/xchainSlice'
import {
    fetchXPTransactions,
...
export default function GlobalReloadButton({ style }: { style?: React.CSSProperties }) {
    ...
    const handleClick = async () => {
        if (
            ...
            let chainId =
                chainName === ChainType.X_CHAIN ? getChainID(chainAlias) : getChainID(chainAlias)
            dispatch(
                loadNumberOfPXTransactions({
